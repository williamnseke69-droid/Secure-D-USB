...
categorie= {"prioritaire":fichiers_prioritaires, "systeme_prioritaire":filesys_prioritaires, 
            "cache":fichiers_caches, "sans_extension":without_extensions, "exetnsion_double":double_extension, "normal":fichiers_normaux}

def categoriser_fichiers(liste_fichiers):
    
    for element in liste_fichiers:
       name_fichier= os.path.basename(element)
       nom,extensions= os.path.splitext(name_fichier)
...
def fill_type_fichier():
    for element in fichiers_de_la_cle:
       categorie_fichier= categoriser_fichiers(fichiers_de_la_cle)              
